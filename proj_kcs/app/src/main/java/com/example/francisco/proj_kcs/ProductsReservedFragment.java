 ...
 */
public class ProductsReservedFragment extends Fragment {
    ...
    public ProductsReservedFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((MainActivity) getActivity()).getSupportActionBar().setTitle(R.string.reserva);
        RelativeLayout view = (RelativeLayout) inflater.inflate(R.layout.fragment_products_reserved, container, false);
        setHasOptionsMenu(true);

        noProducts = view.findViewById(R.id.noProducts);

        myList = (ListView) view.findViewById(R.id.productsListViewReserved);
        ...
        cursor = db.getProductsReserved(id_user, "Reserva");
    ...
    public void criarList() {
        ...
        String[] columns = new String[]{
                ...
                DatabaseHelper.LOCAL_RESERVA,
                DatabaseHelper.DATA_COMPRA,
        };

        int[] boundTo = new int[]{
                R.id.productNameReserva,
                R.id.imageReserva,
                R.id.localReservaValor,
                R.id.dateReserva
        };

        simpleCursorAdapter = new SimpleCursorAdapter(getActivity(), R.layout.pagina_produto_reserva, cursor, columns, boundTo, 0);
        simpleCursorAdapter.setViewBinder(new SimpleCursorAdapter.ViewBinder() {
            ...
            public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
                ...
                if (columnIndex == 4) {
                    ...
                    textView.setText("Data de reserva: " + data);
